...
set(Noos_DEPENDENCIES ${Boost_LIBRARIES} ${OPENSSL_LIBRARIES} ${CMAKE_DL_LIBS})

#OpenCV
if (${USE_OPENCV})
    find_package(OpenCV QUIET)
    if (!${OpenCV_VERSION})
        message(STATUS "OpenCV Not Found. Building library without it")
    else()
        include_directories(${OpenCV_INCLUDE_DIRS})
        message(STATUS "${Green}Using OpenCV Version: ${OpenCV_VERSION} ${ColourReset}")    
        set(Noos_DEPENDENCIES ${Noos_DEPENDENCIES} ${OpenCV_LIBRARIES}) 
        set(HAVE_OPENCV 1)
    endif()
endif()
